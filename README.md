...
# Usage:
- git clone `https://github.com/ousemaousema`
- cd RED_HAWK
- php rhawk.php
...
Want to contribute to RED HAWK or point out something wrong? Just create a new issue here: https://github.com/ousemaousema/
I'd love to hear from you.

# Support and Donations
Found RED HAWK cool? well you could buy me a cup of tea ;) (no alcohol plz xD) just send any amount of donations (in PayPal) to this address : **ousemw@gmail.com**
